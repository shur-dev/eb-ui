...
export default (variables /* : * */ = variable) => {
  ...
  const buttonTheme = {
    '.disabled': {
      ...
      opacity: variables.buttonDisabledOpacity
    },
    '.bordered': {
      '.dark': {
        ...darkCommon,
    ...
    'NativeBase.Text': {
      ...
      letterSpacing: variables.buttonLetterSpacing,
      backgroundColor: 'transparent',
      textTransform: variables.buttonTextTransform,
    },
    ...
    borderColor: variables.buttonPrimaryBg,
    height: variables.buttonDefaultHeight,
    borderWidth: null,
    flexDirection: 'row',
    elevation: 2,
    shadowColor:
    ...
    shadowOpacity: platformStyle === PLATFORM.MATERIAL ? variables.buttonShadowOpacity : undefined,
